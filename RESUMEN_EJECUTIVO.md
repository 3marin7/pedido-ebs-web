...
### Base de Datos:
```
✅ SQL_CREAR_TABLA_MOVIMIENTOS.sql               (Script SQL completo)
```
...
1. Abre `SQL_CREAR_TABLA_MOVIMIENTOS.sql`
...
- [ ] Copiar script SQL del archivo `SQL_CREAR_TABLA_MOVIMIENTOS.sql`

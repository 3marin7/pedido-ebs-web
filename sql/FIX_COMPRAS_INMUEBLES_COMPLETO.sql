...
-- Corrige tablas, columnas, permisos y políticas sin fallar si ya existen.
...
create policy "compras_inmuebles_select_app" on public.compras_inmuebles for select to anon, authenticated using (true);
create policy "compras_inmuebles_insert_app" on public.compras_inmuebles for insert to anon, authenticated with check (true);
create policy "abonos_inmueble_select_app" on public.abonos_inmueble for select to anon, authenticated using (true);
create policy "abonos_inmueble_insert_app" on public.abonos_inmueble for insert to anon, authenticated with check (true);
